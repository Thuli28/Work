...
def history():
    ...
    # Query database for user's transaction, order by most recent first
    ...
    return render_template("history.html", transactions=transactions, usd=usd, type=type)
...
def register():
    ...
    if request.method == "POST":
        ...
        # Ensure password and confirmition match
